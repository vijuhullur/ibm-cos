...
| IBM Cloud Object Storage (Classic)  | COS API   | This version provides certain regulatory compliance only available when purchasing through IBM Cloud Classic (SoftLayer).  Does not support IBM Cloud IAM or Key Protect. | [Link](/docs/infrastructure/cloud-object-storage-infrastructure/about-cos.html) |
